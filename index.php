...
<body>
  ...
  ?>
	...
	<div><input type="button" id="HideMenuID" value="Hide Menu" /></div>
		...
		<strong>
    <a href="about.php">About this map</a></strong>
        ...
        <div class="divider"></div>
          ...
          <label>
              <input type="checkbox" id="transitLayer" value="" />
                Google Transit Layer</label> <img src="images/question_mark.jpg" align="absbottom" width="16" height="16" title="Google's Transit Layer shows rail transit lines." alt="Google's Transit Layer shows rail transit lines." /><br />
		</div>
          ...
          <label>
              <input type="checkbox" id="trafficLayer" value="" />
                Google Realtime Traffic</label> <img src="images/question_mark.jpg" align="absbottom" width="16" height="16" title="Google's Traffic Layer shows real-time traffic conditions." alt="Google's Traffic Layer shows real-time traffic conditions." /><br />
		</div>
